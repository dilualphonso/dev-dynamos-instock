      ...
      <li className="inventory">
        <div className="inventory__box">
          <div className="inventory__container">
            <div className="inventory__wrapper">
              <div className="inventory__details inventory__details-left">
                <div className="inventory__item">
                  ...
                  <Link
                    to={`/inventory/${id}`}
                    className="inventory__value inventory__item-name"
                  >
                    {item_name}
              ...
              <div className="inventory__details inventory__details-right">
                <div className="inventory__status">
                  ...
                  <p
                    className={`inventory__value inventory__status-text ${
            ...
            <div
              className={`inventory__warehouse ${
                warehouseId ? "inventory__warehouse--has-warehouse" : ""
              }`}
            >
          ...
          <div className="inventory__actions">
            <figure
              className="inventory__action-button inventory__action-delete-button"
              onClick={() => handleDeleteClick(id, item_name)}
            >
              <DeleteIcon />
            </figure>
            <Link
              to={`/inventory/${id}/edit`}
              className="inventory__action-button inventory__action-edit-button"
            >
              <EditIcon />
            </Link>
          </div>

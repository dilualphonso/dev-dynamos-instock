      ...
      <div className="warehouse__box">
        <div className="warehouse__tab-headings">
          <div className="warehouse__headings-name">
            ...
            <Sorting
              onAscClick={() => handleAscClick("warehouse_name")}
              onDescClick={() => handleDescClick("warehouse_name")}
            />
          </div>
          <div className="warehouse__headings-address">
            <h4 className="warehouse__address-heading">Address</h4>
            <Sorting
              onAscClick={() => handleAscClick("address,city,country")}
              onDescClick={() => handleDescClick("address,city,country")}
            />
          </div>
          <div className="warehouse__headings-contact-name">
            <h4 className="warehouse__contact-name-heading">Contact Name</h4>
            <Sorting
              onAscClick={() => handleAscClick("contact_name")}
              onDescClick={() => handleDescClick("contact_name")}
            />
          </div>
          <div className="warehouse__headings-contact-info">
            <h4 className="warehouse__contact-info-heading">
              Contact Information
            </h4>
            <Sorting
              onAscClick={() => handleAscClick("contact_phone,contact_email")}
              onDescClick={() => handleDescClick("contact_phone,contact_email")}
            />
          </div>
              ...
              <div className="warehouse__wrapper">
                <div className="warehouse__container">
                  ...
                  <div className="warehouse__right-container">
                    <div className="warehouse__contact-name-container">
                      <h4 className="warehouse__contact-name-label">
                        Contact Name
                      </h4>
                    ...
                    <div className="warehouse__contact-info-container">
                      <h4 className="warehouse__contact-info-label">
                        Contact Information
                      </h4>
                      <div className="warehouse__contact-info">
                        <div className="warehouse__contact-phone">
                          {warehouse.contact_phone}
                        </div>
                        <div className="warehouse__contact-email">
                ...
                <div className="warehouse__icons">
                  <button
                    ...
                    onClick={() =>
                      handleDeleteClick(warehouse.id, warehouse.warehouse_name)
                    }
                  >
                    <img
                  ...
                  <Link to={`/warehouses/${warehouse.id}/edit`}>
                    {" "}
                    <button className="warehouse__edit-icon">
